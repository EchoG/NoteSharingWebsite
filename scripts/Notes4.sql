...
-- Dumping data for table notes.comment: ~11 rows (approximately)
DELETE FROM `comment`;
...
-- Dumping data for table notes.review: ~15 rows (approximately)
DELETE FROM `review`;
...
INSERT INTO `review` (`review_id`, `tag`, `forward_id`, `forward_user`, `isbn`, `user_id`, `rating`, `content`, `filetype`, `uploadfile`, `authority`) VALUES
	(1, '随笔', 0, NULL, '致我们终将逝去的青春', 'echo', NULL, '低吟一缕清风，静守安然；浅弹一阕弦音，追诉流年；陌上寒烟，阐释青春个中深意。光阴流转，岁月渗透忧伤，曾经的那人、那事、那段过往，千年轮回，随着云烟苍老。满月风华，也许，只是一曲流觞，祭奠青春年华，或走，或停，或遥首……', '个人情感', NULL, 2),
	(2, '小说', 0, NULL, '无比芜杂的心绪', 'chris', NULL, '我已经被这样问了几百遍。由于我曾经和他一起做过《地下》的采访，好像作为一个近距离接触他的人有义务汇报一样，总有人这么问我。但这很难回答。本来要用三言两语来形容一个人就很困难，更何况是世界性的村上。就算曝一些他在搭乘电车的时候，笨手笨脚地丢了车票，在检票口把浑身上下翻了个遍，喝啤酒的时候会自称“俺”，一会儿又改称“我”之类的趣事，也只会变成是我胡诌，破坏“世界的村上”的形象。虽说如此，也不能用一句“不知道”回应，让人家以为他这个人毫无人情味，也令人犯愁。我就暂且这么回答。', '日常杂谈', NULL, 2),
	(3, '散文', 0, NULL, '国富论有感', 'chris', NULL, '亚当·斯密（Adam Smith, 1723-1790）是经济学的主要创立者。他于1723年出生在苏格兰的克科底，青年时就读于牛津大学。1751年到1764年在格斯哥大学担任哲学教授。在此期间发表了他的第一部著作《道德情操论》，确立了他在知识界的威望。但是他的不朽名声主要在于他在1776年发表的伟大著作《国家财富的性质和原因的研究》。该书一举成功，使他在余生中享受着荣誉和爱戴。1790年，亚当·斯密在克科底去逝。他一生未娶，没有子女。', '理性分析', NULL, 2),
	(4, '管理', 0, NULL, '生如夏花-死如秋叶', 'chris', NULL, '在最美好的年龄遇到你爱的人，在最富激情的时候读到你喜欢的诗，那感觉大概是一样的吧。泰戈尔的诗集我很早的时候就读过，在一定程度上那是我爱上文学的启蒙力量之一。泰戈尔诗歌的译本很多，且不乏大家与名家。伊沙夫妇将泰翁的诗歌重新翻译，却翻译的那么美，的确令人有些意外之感。我看伊沙伉俪的译本，多少是抱着些比照心态的，然而一看之下，大觉惊艳。', '逸闻趣事', NULL, 2),
	(5, '随笔', 0, NULL, '流行音乐的秘密', 'echo', 2, '　“人人都有欣赏和评价艺术的权利，但不是每个人都有足够的艺术判断力，艺术的标准最终是由少数人定义的，你可以不接受，也可以另起炉灶再搞一套，但它始终在那，并不会因为多了你的标准，就出现「多重标准」。所谓的「多重标准」其实就是没有标准。音乐分类学，及以此为基础的音乐评价体系（如格莱美），不是在评价作品，而是在迎合受众甚至蒙蔽受众。” ', '理性分析', NULL, 2),
	(9, '小说', 2, 'Chris', '霍乱时期的爱情', 'adam', NULL, '如果在阅读中掩去作者的姓名背景，我也将毫不怀疑地断定，这本充满迟暮感伤的书，出自一位老者。不过在此之前，我已获得了关于此书的初步印象：它完成于1985年，当时57岁的加西亚•马尔克斯，于四年前得到诺贝尔奖，正享有着与日俱增的世界性荣耀。', '日常杂谈', NULL, 2),
	(10, '散文', NULL, NULL, '小王子', 'echo', 4, '小王子是一个超凡脱俗的仙童，他住在一颗只比他大一丁点儿的小行星上。陪伴他的是一朵他非常喜爱的小玫瑰花。但玫瑰花的虚荣心伤害了小王子对她的感情。小王子告别小行星，开始了遨游太空的旅行。他先后访问了六个行星，各种见闻使他陷入忧伤，他感到大人们荒唐可笑、太不正常。只有在其中一个点灯人的星球上，小王子才找到一个可以作为朋友的人。但点灯人的天地又十分狭小，除了点灯人他自己，不能容下第二个人。在地理学家的指点下，孤单的小王子来到人类居住的地球。', '逸闻趣事', NULL, 2),
	(11, '管理', NULL, NULL, '白夜行', 'lucy', 4, '“只希望能手牵手在太阳下散步”，这个象征故事内核的绝望念想，有如一个美丽的幌子，随着无数凌乱、压抑、悲凉的故事片段像纪录片一样一一还原：没有痴痴相思，没有海枯石烂，只剩下一个冰冷绝望的诡计，最后一丝温情也被完全抛弃，万千读者在一曲救赎罪恶的凄苦爱情中悲切动容……', '理性分析', NULL, 2),
	(12, '随笔', NULL, NULL, '苏菲的世界', 'lily', 4, '14岁的少女苏菲某天放学回家，发现了神秘的一封信。----你是谁？----世界从哪里来？就这样，在一位神秘导师的指导引下，苏菲开始思索从古希腊到康德，从祁克果到佛洛伊德等各位大师所思考的根本问题。与此同时，苏菲不断接到了些极不寻常的来信，世界像迹团一般在她眼底展开。苏菲运用少女天生的悟性与后天知识，企图解开这些迹团然而事实真相远比她所想的更怪异、更离奇……《苏菲的世界》，即是智慧的世界，梦的世界。它将会唤醒每个人内心深处对生命的赞叹与对人生终极意义的关怀和好奇。', '日常杂谈', NULL, 2),
	(13, '小说', NULL, NULL, '何以笙箫默', 'echo', 3, '我以为，这一切都是姻缘的安排。大学时代的赵默笙阳光灿烂，对法学系大才子何以琛一见倾心，开朗直率的她拔足倒追，终于使才气出众的他为她停留驻足……然而由于命运的捉弄 ', '个人情感', NULL, 2),
	(15, '散文', NULL, NULL, '华胥引', 'echo', 2, '宋凝这个姑娘是不容易得到幸福的，她想嫁大英雄，性子倔强不服输，男子一般不都是喜欢为温柔婉约的女子么。而阿凝的天真，阿凝的温柔，她只想让沈岸看见。可是世界上阴差阳错的事情有多少，况且还有柳萋萋的从中作梗。宋凝一心一意爱着沈岸，她的爱情已经卑微到了不能再低的地步，但她的表面依然坚强风雨不摧。可惜宋凝心里想的，沈岸永远不知道。 ', '个人情感', NULL, 2),
	(16, '管理', 12, 'Echo', '碧河彼时', 'chris', 4, '奉行自由主义的大不列颠，永远将“自由”供奉在“平等”之前，所以“红眼病”发病率不高，“势利眼”十分常见，“成功人士”走到哪里，都会受人青睐，其结果，是等级梯次井然有序，价值观念相对保守。以剑桥各学院的中心草坪来说，祖制规定，唯有院长和教授方有资格潇洒地斜行穿越，他们目不斜视、趾高气昂、袍子内虎虎生风。因此，当可怜的查尔斯经受严酷的考验——伙伴们把他的帽子扔到三一学院的大草坪上，看他敢不敢走上草坪去把它捡回来——他不免内心挣扎，在学院的“神圣草坪”上行走，几乎是每一个“剑桥孩子”能够犯下的最严重罪行。', '理性分析', NULL, 2),
	(17, '随笔', NULL, NULL, '我们仨', 'echo', 2, '偶尔夜里睡不着，还会爬起来找书看，又是《我们仨》看过几遍了，还是喜欢的要命。看钱钟书和杨绛，这么两个乱世学人，淡泊宁静的，与世无争，与人无求，不事权贵，不理世事，袖手书斋，大隐隐于心，躲在人群背后，读书写字做学问，这样安静舒张的心，现在已经没有了吧，被灼热物欲驱动的心，虚弱又不宁，谁还敢理直气壮的声称自己享受着绝尘的精神生活？钱钟书和杨绛，说到底还是骨子里有精英意识，中国人所谓士子气，知识分子的倨傲的人，他们并不鄙夷引车卖浆者流，这个精英，是与富贵官贾，社交名流相对的', '理性分析', NULL, 2),
	(43, '小说', NULL, NULL, '往事并不如烟', 'chris', NULL, '我一向认为人老了，简单的衣食住行，都是无比的沉重与艰难，他们的内心自不会再有炽热之情或刻骨之思。但我面前的史良，以忧伤表达出的至爱，令我感动不已。当我跨入老龄，生活之侣也撒手人寰的时候，史良的涕泣和那方白手帕的记忆，便愈发地生动起来，也深刻起来。是的，脆弱的生命随时可以消失，一切都可能转瞬间即空，归于破灭，惟有死者的灵魂和生者的情感是永远的存在。', '个人情感', '', 2),
	(44, '小说', NULL, NULL, '时光的旅行', 'echo', NULL, '<font face="华文彩云">只能用碎片来形容，但许许多多的碎片串联起一整段旅行，而且旅行的精华往往也是一些碎片。比如我能想起第一次去马来西亚，兰卡威一家海滨旅馆的服务生和我在海边唱《海贼王》的片尾曲，</font>他是因为喜欢OP，我是因为喜欢片尾曲的演唱者东方神起。这种零碎的琐事是特别小，但却特别能记得住。 慕容引刀这本绘本，旅行本身并不是重点，远方<font face="Tahoma">的</font><font face="Arial">人和事像</font>充满暖意的吉光片羽闪耀在整本书里，令人读来能够会心一笑，也能恍然大悟。书里.', '日常杂谈', '', 2),
	(45, '散文', 3, 'Chris', '国富论有感', 'echo', NULL, '亚当·斯密（Adam Smith, 1723-1790）是经济学的主要创立者。他于1723年出生在苏格兰的克科底，青年时就读于牛津大学。1751年到1764年在格斯哥大学担任哲学教授。在此期间发表了他的第一部著作《道德情操论》，确立了他在知识界的威望。但是他的不朽名声主要在于他在1776年发表的伟大著作《国家财富的性质和原因的研究》。该书一举成功，使他在余生中享受着荣誉和爱戴。1790年，亚当·斯密在克科底去逝。他一生未娶，没有子女。', NULL, NULL, 2);
...
INSERT INTO `user` (`user_id`, `name`, `password`, `email`, `gender`, `come_from`, `create_time`, `portrait_small`, `portrait_large`, `sort_ind`) VALUES
	...
	('joe', 'joe', '123', 'm', 'cgong@fudan.edu.cn', 'shanghai', '2012-06-23', 'img/people/person1.png', 'img/user2.jpg', 0),
