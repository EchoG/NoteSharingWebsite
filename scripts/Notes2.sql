...
-- Dumping data for table notes.comment: ~8 rows (approximately)
DELETE FROM `comment`;
...
-- Dumping data for table notes.rate: ~13 rows (approximately)
DELETE FROM `rate`;
...
-- Dumping data for table notes.review: ~6 rows (approximately)
DELETE FROM `review`;
/*!40000 ALTER TABLE `review` DISABLE KEYS */;
INSERT INTO `review` (`review_id`, `tag`, `forward_id`, `forward_user`, `isbn`, `user_id`, `rating`, `content`) VALUES
	(1, '随笔', 0, NULL, '9787111255833', 'echo', NULL, '好'),
	(2, '小说', 0, NULL, '9787115232687', 'chris', NULL, '好'),
	(3, '散文', 0, NULL, '9787111255833', 'echo', NULL, '000000000000000000000000'),
	(4, '管理', 0, NULL, '9787111255833', 'chris', NULL, '寰堥樋榫欑殑\n                                '),
	(5, '随笔', 0, NULL, '9787111255833', 'echo', NULL, '2321434325235235'),
	(9, '小说', 2, 'Chris', '9787115232687', 'echo', NULL, '好');
