...
-- Dumping data for table notes.review: ~23 rows (approximately)
DELETE FROM `review`;
...
INSERT INTO `review` (`review_id`, `tag`, `forward_id`, `forward_user`, `isbn`, `user_id`, `rating`, `content`, `filetype`, `uploadfile`, `authority`, `pubtime`) VALUES
	...
	(61, '管理 技术 编程', NULL, NULL, 'Prolog', 'lily', NULL, '<font face="sans-serif"><span style="font-size: 15px; line-height: 22.078125px;"><font color="#dc143c">Prolog</font>（Programming in Logic的缩写）是一种逻辑编程语言。它建立在逻辑学的理论基础之上， 最初被运用于自然语言等研究领域。现在它已广泛的应用在人工智能的研究中，它可以用来建造专家系统、自然语言理解、智能知识库等。</span></font>', '技术文档', '', 3, '2013-07-02 04:35:42');
...
-- Dumping data for table notes.review_tag: ~23 rows (approximately)
